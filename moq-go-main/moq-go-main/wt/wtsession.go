...
func (wts *WTSession) Close() error {
	return wts.quicConn.CloseWithError(0, "closed")
}

// Read implements io.Reader
func (wts *WTSession) Read(p []byte) (n int, err error) {
	// WebTransport body reading not implemented in this test
	return 0, nil
}
